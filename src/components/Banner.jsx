...
export function Banner() {
  ...
  return (
    <div>
      <section
        className="bg-no-repeat bg-cover bg-center bg-blend-multiply bg-gray-400 p-4 h-full"
        style={{ backgroundImage }}
      >
        <div className="px-4 mx-auto max-w-screen-xl py-36 md:py-40 lg:py-52">
      ...
      <section className="bg-center bg-no-repeat bg-[url('../src/assets/banner.jpg')] bg-gray-400 bg-blend-multiply h-full">
        <div className="px-4 mx-auto max-w-screen-xl text-center py-36 md:py-40 lg:py-52">
          <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-5xl">
            Bienvenido al sitio de actividades del semestre
          </h1>
          <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Aqui encontrarás un recopilatorio de todas las actividades
            realizadas durante el semestre, organizadas de manera clara y
            accesible.
          </p>
